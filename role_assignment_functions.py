...
def create_interleaving_tree_roles(max_length, vocab_size):
	role_dict = {}
	'''
	role_dict[1] = [0]
	role_dict[2] = [1, 0]
	role_dict[3] = [1, 2, 0]
	role_dict[4] = [3, 1, 2, 0]
	role_dict[5] = [3, 4, 1, 2, 0]
	role_dict[6] = [3, 5, 4, 1, 2, 0]
	'''

	role_dict[1] = [43]
	role_dict[2] = [58, 43]
	role_dict[3] = [58, 14, 43]
	role_dict[4] = [16, 58, 14, 43]
	role_dict[5] = [16, 3, 58, 14, 43]
	role_dict[6] = [16, 6, 3, 58, 14, 43]

	interleaving_function = lambda fillers: role_dict[len(fillers)]

	return 60, interleaving_function
